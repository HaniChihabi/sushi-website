...
export default function Navbar() {
    ...
    const controlNavbar = () => {
        // Hide navbar and change background to black when scrolling down and past 5px
    ...
    return (
        <nav className={`fixed flex z-50 justify-between w-full p-7 transition-opacity duration-500 ${navbarBg} navbar-transition`}>
            <Link href="/">
